...
% Last updated on 2021-07-12 (MATLAB R2019a)
...
baseSea = 16; % What is the max seaward slope at the cliff base (deg)?
baseLand = 28; % What is the min landward slope at the cliff base (deg)?
...
for k = 1:size(theFiles,1)
    ...
    base = baseFileName([1:end-4]);table
